...
3. Read `state-management.md` before adding state.
4. Read `type-safety.md` before defining API/domain types.
5. For cross-layer API work, read `../guides/cross-layer-thinking-guide.md`.
