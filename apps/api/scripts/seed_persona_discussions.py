...
PERSONAS: tuple[PersonaSpec, ...] = (
    ...
    PersonaSpec("远山便利店", "yuanshan_shop@parallellines.local", "收藏一些顺手的小工具。"),
    PersonaSpec("老槐", "old_huai_tree@parallellines.local", "偶尔认真，偶尔摆烂。"),
    PersonaSpec("oldhuai", "oldhuai@parallellines.local", "路过看看，也会留两句。"),
    PersonaSpec("huai_07", "huai_07@parallellines.local", "对产品细节有点挑。"),
    PersonaSpec("Aki_慢慢来", "aki_slow@parallellines.local", "慢慢做也算做。"),
    PersonaSpec("momo-离线", "momo_offline@parallellines.local", "不在线的时候比较像自己。"),
    PersonaSpec("kk不在线", "kk_offline@parallellines.local", "收藏夹总是爆满。"),
    PersonaSpec("Nate_路过", "nate_passby@parallellines.local", "路过补充一点点。"),
    PersonaSpec("小K_再看看", "xiaok_look@parallellines.local", "先看看，再决定。"),
    PersonaSpec("rain_404", "rain404@parallellines.local", "不太会坚持，但还在试。"),
    PersonaSpec("zzZ_醒了", "zzz_awake@parallellines.local", "每天都在和闹钟协商。"),
