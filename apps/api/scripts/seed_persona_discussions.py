...
PERSONAS: tuple[PersonaSpec, ...] = (
    ...
    PersonaSpec("momo-离线", "momo-offline@pingxingxian.space", "不在线的时候比较像自己。"),
    PersonaSpec("kk不在线", "kk-offline@pingxingxian.space", "收藏夹总是爆满。"),
    PersonaSpec("Nate_路过", "nate-passby@pingxingxian.space", "路过补充一点点。"),
    ...
    PersonaSpec("穿猫的靴子", "cat-boots@pingxingxian.space", "写点看到的变化和小趋势。"),
    PersonaSpec(
        "小漫家",
