"""add chat channels messages and presence

Revision ID: 0028_chat_presence
Revises: 0027_user_profile_settings
...
revision: str = "0028_chat_presence"
down_revision: str | None = "0027_user_profile_settings"
...
def downgrade() -> None:
    op.drop_index("ix_chat_presence_channel_seen", table_name="chat_presence")
    op.drop_table("chat_presence")
    op.drop_index("ix_chat_channel_members_user_created", table_name="chat_channel_members")
    ...
    op.drop_index("ix_chat_channels_board", table_name="chat_channels")
    op.drop_index("ix_chat_channels_type_last_message", table_name="chat_channels")
