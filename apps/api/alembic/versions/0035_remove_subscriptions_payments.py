"""remove subscriptions and payments

Revision ID: 0035_remove_subscriptions_payments
Revises: 0034_content_localizations
...
revision: str = "0035_remove_subscriptions_payments"
down_revision: str | None = "0034_content_localizations"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    drop_table_if_exists("payment_events")
    drop_table_if_exists("user_subscriptions")
    drop_table_if_exists("subscription_plans")
...
def downgrade() -> None:
    ...
    if not table_exists("payment_events"):
        op.create_table(
            "payment_events",
            sa.Column("id", sa.BigInteger(), primary_key=True, comment="支付事件 ID。"),
            sa.Column("provider", sa.String(length=32), nullable=False, comment="支付 provider。"),
            sa.Column(
                "event_id", sa.String(length=160), nullable=False, comment="provider 事件 ID。"
            ),
        ...
        op.create_index(
            "ix_payment_events_user_created", "payment_events", ["user_id", "created_at"]
        )
