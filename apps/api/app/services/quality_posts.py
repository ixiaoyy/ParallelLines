...
QUALITY_POST_SPECS = [
    ...
    QualityPostSpec(
        key="first-steps",
        title="新手指南：第一次来到平行线，可以从这 5 件小事开始",
        raw_md=(
            "# 新手指南：第一次来到平行线，可以从这 5 件小事开始\n\n"
            "欢迎来到平行线。这里不要求你一开始就写长文，也不要求每个想法都很成熟。"
            "更重要的是，把值得留下的东西先记录下来，再慢慢和别人讨论、补充、修正。\n\n"
            "## 你可以先做这些小事\n\n"
            "1. **介绍一个你最近在关注的问题**：不必有答案，写清背景就很好。\n"
            "2. **收藏或分享一个真正有用的资源**：说明适合谁、怎么用、有什么限制。\n"
            "3. **记录一次小复盘**：发生了什么、你怎么处理、下次会怎么做。\n"
            "4. **提出一个产品或社区建议**：写出使用场景和你希望改变的地方。\n"
            "5. **回复一条你有共鸣的帖子**：补充经验、提出追问，或只是说说你看见了什么。\n\n"
            "## 不知道发到哪里？\n\n"
            "- 资源、工具、资料：发到「资源荟萃」。\n"
            "- 遇到困惑、想请大家帮忙：发到「有问必答」。\n"
            "- 亲身经历、方法、踩坑复盘：发到「经验分享」。\n"
            "- 对网站功能或社区氛围的建议：发到「社区反馈」。\n"
            "- 生活片段、旧日文字、每日金句：发到「微光手记」。\n\n"
            "如果暂时分不清，先发出来也没关系；版主可以帮你调整版块和标签。"
        ),
        tags=["公告", "新手指南", "发帖模板"],
        pinned=False,
        featured=True,
    ...
    QualityPostSpec(
        ...
        title="提问模板：把背景、尝试和卡点写清楚",
        raw_md=(
            "# 提问模板：把背景、尝试和卡点写清楚\n\n"
            "一个好问题不一定很专业，但通常会给读者足够的上下文。"
            "你越容易让别人理解现场，别人就越容易给出有用回复。\n\n"
            "## 推荐结构\n\n"
            "### 1. 我想解决什么\n\n"
            "用一两句话说明目标：你希望得到一个判断、一个方案，还是一个排查思路？\n\n"
            "### 2. 当前现象是什么\n\n"
            "贴出具体表现、错误信息、截图文字或复现步骤。涉及隐私时请先打码。\n\n"
            "### 3. 我已经试过什么\n\n"
            "列出你查过的资料、尝试过的操作，以及每一步的结果。\n\n"
            "### 4. 我卡在哪里\n\n"
            "说明你现在不确定的是原因、方向、取舍，还是具体执行步骤。\n\n"
            "## 一个简短例子\n\n"
            "> 我想整理浏览器收藏夹，但分类越分越乱。"
            "目前有 300 多个链接，试过按主题建文件夹，但一周后又开始混放。"
            "我想知道有没有更懒人一点、能长期坚持的整理方法。\n\n"
            "如果你的问题暂时还很混乱，也可以先把「已知事实」写出来，大家再一起帮你拆。"
        ),
        tags=["发帖模板", "求助", "新手指南"],
        pinned=False,
        featured=True,
    ...
    QualityPostSpec(
        key="citation-privacy",
        title="转载与隐私：引用来源、截图打码和版权边界",
        raw_md=(
            "# 转载与隐私：引用来源、截图打码和版权边界\n\n"
            "平行线鼓励分享资料、经验和观点，但长期可读的内容也需要尊重来源、保护隐私。"
            "发帖前多做一次确认，能减少误解，也能让讨论更安全。\n\n"
            "## 分享外部内容时\n\n"
            "- 尽量附上原始链接、作者或来源平台。\n"
            "- 不要把他人的完整文章、付费内容、课程资料或大段书摘直接搬运过来。\n"
            "- 可以写摘要、个人理解和使用场景，再引导大家去原文查看。\n"
            "- 如果内容有明显时效性，请标注日期、地区或适用范围。\n\n"
            "## 分享截图时\n\n"
            "- 打码手机号、邮箱、地址、订单号、身份证件、聊天对象头像和昵称。\n"
            "- 不公开他人的私聊、群聊记录，除非已获得明确同意并做好匿名处理。\n"
            "- 涉及公司、客户或未公开项目信息时，优先描述问题，不贴敏感材料。\n\n"
            "## 分享个人经历时\n\n"
            "可以写真实感受，也可以保留必要模糊。"
            "如果一段内容会让你或他人在未来感到不安全，建议先删去可识别细节。"
        ),
        tags=["社区说明", "隐私", "发帖模板"],
        pinned=False,
        featured=True,
