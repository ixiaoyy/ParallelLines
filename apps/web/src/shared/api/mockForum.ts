...
export const topics: TopicCardVM[] = [
  ...
  {
    id: "t-9",
    slug: "login-redirect-edge-only",
    title: "登录回跳首页只在 Edge 复现，应该抓哪些日志？",
    boardSlug: "support",
    boardName: "支持与排障",
    boardColor: "var(--accent-geek)",
    authorName: "Yun",
    posterNames: ["Yun"],
    tags: ["登录", "edge", "日志"],
    excerpt: "SSO 登录成功后偶发回到首页，Chrome 正常。想确认需要前端路由日志还是后端 callback 日志。",
    replyCount: 0,
    viewCount: 318,
    likeCount: 7,
    hotScore: 49,
    lastPostedAt: minutesAgo(36),
    status: "open",
  },
  {
    id: "t-10",
    slug: "upgrade-migration-missing-column",
    title: "升级到 v0.1 后迁移提示缺少 notification_cursor 字段",
    boardSlug: "support",
    boardName: "支持与排障",
    boardColor: "var(--accent-geek)",
    authorName: "Chen",
    posterNames: ["Chen", "平行线小助手", "Moss"],
    tags: ["升级", "迁移", "数据库"],
    excerpt: "执行迁移脚本时 SQLite 环境报缺字段，PostgreSQL 正常。想确认是否遗漏了兼容迁移。",
    replyCount: 3,
    viewCount: 520,
    likeCount: 15,
    hotScore: 62,
  ...
  {
    id: "t-11",
    slug: "api-timeout-import-csv",
    title: "CSV 导入接口 30 秒超时，有没有推荐的排障顺序？",
    boardSlug: "support",
    boardName: "支持与排障",
    boardColor: "var(--accent-geek)",
    authorName: "Nora",
    posterNames: ["Nora", "Sam", "Kai"],
    tags: ["api-timeout", "导入", "队列"],
    excerpt: "用户上传 2 万行 CSV 时请求超时，但后台最终写入成功。需要判断先拆任务还是先优化事务。",
    replyCount: 4,
    viewCount: 880,
    likeCount: 22,
    hotScore: 58,
    lastPostedAt: hoursAgo(5),
    solved: true,
    status: "open",
  },
];
