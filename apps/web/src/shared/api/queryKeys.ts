export const queryKeys = {
  ...
  adminPaymentEvents: ["admin", "payments", "events"] as const,
  events: (startAt = "", endAt = "") => ["events", startAt, endAt] as const,
  chatChannels: ["chat", "channels"] as const,
  chatMessages: (channelId: string, q = "") => ["chat", "channels", channelId, "messages", q] as const,
  chatPresence: (channelId: string) => ["chat", "channels", channelId, "presence"] as const,
